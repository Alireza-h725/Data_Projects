...
| 4 | [Root Cause Analysis](https://public.tableau.com/views/WhatsCausingAlltheReturns/SalesvsReturns?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link) | Analyzed and calculated return rates to identify key trends, then leveraged insights to recommend data-driven solutions and process improvements  |
